                ...
                <div class="p-6">
                    <form action="{{ route('product.store') }}" method="post">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div>
                                <x-label for="initial_stock" :value="__('Stok Awal')" />

                                <x-input id="initial_stock" class="block mt-1 w-full" type="number" min="0" name="initial_stock" :value="old('initial_stock', 0)" />
                                <small class="text-red-500">{{ $errors->first('initial_stock') }}</small>
                            </div>
                            <div>
